<template>
  <div class="grid lg:grid-cols-5 md:pl-44 md:pr-44 h-auto">
    ...
    <div class="col-start-1 col-end-6 flex justify-center items-center p-4 bg-blue-950">
        <h1 class="font-roboto lg:text-3xl text-white font-normal text-center">Iscritti Anno 2023</h1>
    </div>
    <div class="md:flex md:flex-row col-start-1 col-end-6 justify-center">
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
    ...
    <div class="md:flex md:flex-row col-start-1 col-end-6 justify-center">
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR.SSA.BERTI Carola</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
    ...
    <div class="md:flex md:flex-row col-start-1 col-end-6 justify-center">
        ...
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">Dott. GALLO Beniamino</p>
    ...
    <div class="md:flex md:flex-row col-start-1 col-end-6 justify-center">
        ...
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR.SSA INGARGIOLA Sarah</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
    </div>
    <div class="md:flex md:flex-row col-start-1 col-end-6 justify-center">
    ...
    <div class="col-start-1 col-end-6 flex justify-center items-center p-4 bg-blue-950">
        <h1 class="font-roboto lg:text-3xl text-white font-normal text-center">Giudici</h1>
    </div>
    <div class="md:flex md:flex-row col-start-1 col-end-6 justify-center">
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR.SSA FIERRO CLOTILDE</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR. GRILLO PASQUARELLI Federico</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR. ROCCHETTI PIERO</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR.SSA PALIAGA DANIELA</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
    </div>
    <div class="md:flex md:flex-row col-start-1 col-end-6 justify-center">
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">D.SSA PASTORE ROBERTA</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR. NIGRA MARCO</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR. MOLLO MAURO</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
        <div class="lg:w-1/4 bg-blue-950 pl-10 pt-4 pb-8">
            <p class="font-Raleway lg:text-xl text-white font-bold">DR.SSA FILICETTI AURORA</p>
            <p class="font-Raleway lg:text-base text-white font-thin"></p>
        </div>
    </div>
    <div class="md:flex md:flex-row col-start-1 col-end-6 justify-center">
    ...
    <div class="col-start-1 col-end-6 flex justify-center items-center p-4 bg-blue-950">
        <h1 class="font-roboto lg:text-3xl text-white font-normal text-center">Enti e Consulenti</h1>
    </div>
    <div class="col-start-1 col-end-6 flex justify-start  p-2 bg-blue-950">
        <P class="font-roboto lg:text-xl text-white pl-10 font-normal text-left">ORDINE DEI CONSULENTI DEL LAVORO</P>
    </div>
    <div class="col-start-1 col-end-6 flex justify-start  p-2 bg-blue-950">
        <P class="font-roboto lg:text-xl text-white pl-10 font-normal text-left">AZIENDA OSPEDALIERA CITTA’ DELLA SALUTE</P>
    </div>
    <div class="col-start-1 col-end-6 flex justify-start  p-2 bg-blue-950">
        <P class="font-roboto lg:text-xl text-white pl-10 font-normal text-left">GALLO BENIAMINO-FUNZIONARIO INPS</P>
    </div>
    <div class="col-start-1 col-end-6 flex justify-start  p-2 bg-blue-950">
        <P class="font-roboto lg:text-xl text-white pl-10 font-normal text-left">DR.SSA ODDENINO ANNA-CONSULENTE LAVORO</P>
    </div>
