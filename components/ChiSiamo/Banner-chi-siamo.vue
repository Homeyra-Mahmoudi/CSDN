<template>
  <div class="lg:container mx-auto">
    <div class="bg-blue-950 text-white py-10 px-4">
        <h1 class="font-Roboto font-bold text-4xl italic mb-4">Chi Siamo</h1>
        <p class="text-2xl font-light font-Roboto italic">
